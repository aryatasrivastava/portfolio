const projects = [
  {
    ...
    description:
      "An on-screen interface that allows the users to input text without the need for a physical keyboard.",
    image: "/project1.png",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: "Headlines Hub",
    description:
      "An app designed to deliver the latest and most relevant news headlines from various categories",
    image: "/project3.png",
  },
];
